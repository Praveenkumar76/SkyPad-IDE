        ...
        <div className="absolute top-full right-0 mt-2 w-64 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-6 shadow-2xl z-50">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link 
                to="/leaderboard" 
                className={getActiveLinkClass('/leaderboard')}
              >
            ...
            <div className="space-y-4 pt-4 border-t border-white/20">
              <button className="flex items-center space-x-3 text-white hover:text-violet-400 px-4 py-3 rounded-lg font-medium hover:bg-white/5 transition-colors w-full">
              ...
              <Link 
                to="/settings" 
                className={getActiveLinkClass('/settings')}
              >
